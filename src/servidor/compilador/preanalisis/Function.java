 ...
 * @author Jorge
 */
public class Function extends Subrutina {

    public Function(int noparams, Tipo tipo, String firma, Entorno entorno, ArrayList<String> posibles) {
        super(Constantes.FUNCION, noparams, tipo, firma, entorno, posibles);
    }
